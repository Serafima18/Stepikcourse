...
## <u>Что знаю</u>: 
### Работа с информацией о пользователе(ready)
...
### Работа с информацией по grade-book(ready)
...
### Работа с информацией по шагу(ready)
...
### Работа с информацией по уроку(lesson)(ready)
...
### Работа с информацией по модулю(секции)(ready)
...
### Работа с информацией по курсу(ready)
...
### Работа с информацией по классу(ready)
